...
const EquipmentVariantCard = forwardRef<HTMLAnchorElement, EquipmentVariantCardProps>(
  ({ name, slug, parentSlug, image, showForRent = true }, ref) => {
...
EquipmentVariantCard.displayName = "EquipmentVariantCard";
