export const equipmentList = [
  ...
  { name: "JCB Backhoe 3CX", slug: "jcb-backhoe-3cx", description: "Versatile JCB Backhoe 3CX for excavation and loading tasks." },
  { name: "Boomloader", slug: "boomloader", description: "Telehandlers and boomloaders for reaching high and extended areas." },
  { name: "Mini Excavator", slug: "mini-excavator", description: "Compact mini excavators for tight spaces and small projects." },
  { name: "Cranes", slug: "cranes", description: "Mobile and tower cranes for heavy lifting operations." },
  { name: "Manlifts", slug: "manlifts", description: "Aerial work platforms for elevated work access." },
  ...
  { name: "Recovery Trucks 10 Ton", slug: "recovery-trucks-10-ton", description: "10-ton recovery trucks for vehicle recovery and towing." },
  { name: "Generators", slug: "generators", description: "Power generators for construction sites and events." },
  { name: "Compressors", slug: "compressors", description: "Air compressors for pneumatic tools and industrial use." },
  { name: "Skid Steer Bobcat", slug: "skid-steer-bobcat", description: "Bobcat skid steer loaders for versatile construction tasks." },
